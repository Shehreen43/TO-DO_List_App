...
//   function createTodoItem(todo: Todo, todoIndex: number): HTMLLIElement {
...
//     const checkbox = todoLI.querySelector('input[type="checkbox"]') as HTMLInputElement;
...
function createTodoItem(todo: Todo, todoIndex: number): HTMLLIElement {
  ...
  const editButton = todoLI.querySelector('.edit-button') as HTMLButtonElement;
  editButton.addEventListener('click', () => {
    if (!checkbox.checked) {
      const todoTextLabel = todoLI.querySelector('.todo-text') as HTMLLabelElement;
